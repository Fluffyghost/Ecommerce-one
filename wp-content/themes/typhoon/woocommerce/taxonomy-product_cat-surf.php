                ...
                <div class='large-12 cell taxcatwrap' id='scrollcat'>
                    <div class='taxcatwrapinner'>
                        ...
                        <?php $args = array(
                              ...
                              'parent'   => 253,
                              // 'exclude' => 481,
                              'include' => array(388, 428, 441, 427, 266),
                            );
    ...
    <section class="topProducts">
        <div class="grid-container full">
            <div class="grid-x grid-margin-x marT120">
                <div class="large-12 cell">
                    <h2 class="dtext marB50 center">Top Surfing products</h2>
                    <div class="topWrap rel" id="scrollprod">
                        <div class="topinner"><?php echo do_shortcode('[products limit="6" columns="6" orderby="popularity" category="surf" ]'); ?></div>
                    </div>
                </div>
            </div>
